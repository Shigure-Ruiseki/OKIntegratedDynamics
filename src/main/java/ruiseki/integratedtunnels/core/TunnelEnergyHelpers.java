...
public class TunnelEnergyHelpers {
     ...
     */
    public static int moveEnergy(INetwork network,
        IPositionedAddonsNetworkIngredients<Integer, Boolean> ingredientsNetwork, int channel,
        IIngredientComponentStorage<Integer, Boolean> source, IIngredientComponentStorage<Integer, Boolean> target,
        int amount, boolean exact, boolean craftIfFailed) throws EvaluationException {
        int moved;
        try {
            ...
            throw new EvaluationException(
                "Ingredient movement failed " + "due to inconsistent insertion behaviour by destination in simulation "
