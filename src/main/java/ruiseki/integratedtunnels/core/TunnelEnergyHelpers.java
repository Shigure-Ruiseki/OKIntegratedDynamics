...
public class TunnelEnergyHelpers {
     ...
     */
    public static long moveEnergy(INetwork network,
        IPositionedAddonsNetworkIngredients<Long, Boolean> ingredientsNetwork, int channel,
        IIngredientComponentStorage<Long, Boolean> source, IIngredientComponentStorage<Long, Boolean> target,
        long amount, boolean exact, boolean craftIfFailed) throws EvaluationException {
        long moved;
        try {
