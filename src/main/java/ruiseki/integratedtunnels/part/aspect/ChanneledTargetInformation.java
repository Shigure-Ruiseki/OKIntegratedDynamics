...
public class ChanneledTargetInformation<T, M> {
    ...
    protected ChanneledTargetInformation(IngredientPredicate<T, M> fluidStackPredicate, ITunnelTransfer transfer,
        int slot) {
    ...
    public static <T, M> ChanneledTargetInformation<T, M> of(IngredientPredicate<T, M> fluidStackPredicate,
        ITunnelTransfer transfer, int slot) {
