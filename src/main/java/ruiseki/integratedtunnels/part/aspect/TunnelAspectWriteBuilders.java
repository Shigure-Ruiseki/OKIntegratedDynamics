...
import ruiseki.integratedtunnels.core.ItemHandlerWorldEntityExportWrapper;
import ruiseki.integratedtunnels.core.ItemHandlerWorldEntityImportWrapper;
import ruiseki.integratedtunnels.core.ItemStoragePlayerWrapper;
import ruiseki.integratedtunnels.core.TunnelEnergyHelpers;
...
public class TunnelAspectWriteBuilders {
    ...
    public static Entity getEntity(PartPos target, int entityIndex) {
        List<Entity> entities = target.getPos()
            .getWorld()
            .getEntitiesWithinAABB(
                Entity.class,
                new ImmutableAxisAlignedBB(
                    target.getPos()
                        .getBlockPos()));
        Entity entity = null;
        if (entities.size() > 0 && entityIndex < entities.size()) {
            if (entityIndex == -1) {
                entity = entities.get(
                    target.getPos()
                        .getWorld().rand.nextInt(entities.size()));
            } else {
    ...
    public static void validateListValues(ValueTypeList.ValueList list, IValueType<?> expectedValueType)
    ...
    public static final class Energy {
        ...
        public static final IAspectWriteActivator ACTIVATOR = createPositionedNetworkAddonActivator(
            () -> EnergyNetworkConfig.CAPABILITY,
    ...
    public static final class Item {
        ...
        public static final IAspectProperties PROPERTIES_SLOT = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(PROP_CHANNEL, PROP_ROUNDROBIN
            // , PROP_EXACTAMOUNT
                , PROP_SLOT, PROP_PASSIVE_IO, PROP_CHECK_DAMAGE, PROP_CHECK_STACKSIZE));
        public static final IAspectProperties PROPERTIES_RATE = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(PROP_CHANNEL, PROP_ROUNDROBIN, PROP_RATE
            // , PROP_EXACTAMOUNT
                , PROP_PASSIVE_IO, PROP_CHECK_DAMAGE, PROP_CHECK_STACKSIZE));
        public static final IAspectProperties PROPERTIES_RATESLOTCHECKS = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                ...
                PROP_CHECK_NBT,
                PROP_EMPTYISANY));
        public static final IAspectProperties PROPERTIES_RATESLOTCHECKSCRAFT = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                PROP_CHANNEL,
                PROP_ROUNDROBIN,
                PROP_BLACKLIST,
                ...
                PROP_EMPTYISANY,
                PROP_CRAFT));
        public static final IAspectProperties PROPERTIES_RATESLOTCHECKSLIST = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                PROP_CHANNEL,
                PROP_ROUNDROBIN,
                PROP_BLACKLIST,
        ...
        static {
            ...
            PROPERTIES_RATESLOT.setValue(PROP_CHECK_DAMAGE, ValueTypeBoolean.ValueBoolean.of(true));
            ...
            PROPERTIES_RATESLOTPREDICATE.setValue(PROP_CHECK_DAMAGE, ValueTypeBoolean.ValueBoolean.of(true));
            ...
            PROPERTIES_SLOT.setValue(PROP_CHECK_DAMAGE, ValueTypeBoolean.ValueBoolean.of(true));
            ...
            // PROPERTIES_RATE.setValue(PROP_EXACTAMOUNT, ValueTypeBoolean.ValueBoolean.of(false));
            PROPERTIES_RATE.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(true));
            PROPERTIES_RATE.setValue(PROP_CHECK_DAMAGE, ValueTypeBoolean.ValueBoolean.of(true));
            ...
            PROPERTIES_RATESLOTCHECKSCRAFT.setValue(
                PROP_CHANNEL,
                ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
            ...
            PROPERTIES_RATESLOTCHECKSLIST.setValue(
                PROP_CHANNEL,
                ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
            ...
            PROPERTIES_FILTER_CHECKS.setValue(PROP_CHECK_DAMAGE, ValueTypeBoolean.ValueBoolean.of(true));
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Boolean>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>> PROP_BOOLEAN_ITEMPREDICATE = input -> {
            ...
            int slot = input.getMiddle()
                .getValue(PROP_SLOT)
                .getRawValue();
            return Triple.of(
                input.getLeft(),
                input.getMiddle(),
                ChanneledTargetInformation.of(itemStackMatcher, itemStackMatcher, slot));
        };
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Integer>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>> PROP_INTEGER_SLOT_ITEMPREDICATE = input -> {
            IAspectProperties properties = input.getMiddle();
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ItemStack>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>> PROP_ITEMSTACK_ITEMPREDICATE = input -> {
            IAspectProperties properties = input.getMiddle();
            boolean checkStackSize = properties.getValue(PROP_CHECK_STACKSIZE)
                .getRawValue();
            boolean checkDamage = properties.getValue(PROP_CHECK_DAMAGE)
                .getRawValue();
            ...
            if (input.getRight() == null) {
                IngredientPredicate.EmptyBehaviour emptyBehaviour = IngredientPredicate.EmptyBehaviour.fromBoolean(
                    properties.getValue(PROP_EMPTYISANY)
                        .getRawValue());
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ValueTypeList.ValueList>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>> PROP_ITEMSTACKLIST_ITEMPREDICATE = input -> {
            ...
            IngredientPredicate<ItemStack, Integer> itemStackMatcher = TunnelItemHelpers.matchItemStacks(
                list.getRawValue(),
                true,
                checkStackSize,
                checkDamage,
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ValueTypeOperator.ValueOperator>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>> PROP_ITEMSTACKPREDICATE_ITEMPREDICATE = input -> {
            IOperator predicate = input.getRight()
                .getRawValue();
            if (predicate.getInputTypes().length == 1
                ...
                boolean exactAmount = properties.getValue(PROP_EXACTAMOUNT)
                    .getRawValue();
                IngredientPredicate<ItemStack, Integer> itemStackMatcher = TunnelItemHelpers
                    .matchPredicateItem(input.getLeft(), predicate, amount, exactAmount);
                int slot = properties.getValue(PROP_SLOT)
                    .getRawValue();
                return Triple.of(
                    input.getLeft(),
                ...
                String expected = ValueTypeOperator
                    .getSignature(new IValueType[] { ValueTypes.OBJECT_ITEMSTACK }, ValueTypes.BOOLEAN);
                throw new EvaluationException(
                    new LangHelpers.UnlocalizedString(L10NValues.ASPECT_ERROR_INVALIDTYPE, expected, current)
                        .localize());
            }
        };
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, NBTTagCompound>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>> PROP_NBT_ITEMPREDICATE = input -> {
            ...
            int slot = properties.getValue(PROP_SLOT)
                .getRawValue();
            boolean subset = properties.getValue(PROP_NBT_SUBSET)
                .getRawValue();
            boolean superset = properties.getValue(PROP_NBT_SUPERSET)
                .getRawValue();
            boolean requireNbt = properties.getValue(PROP_NBT_REQUIRE)
                .getRawValue();
            boolean recursive = properties.getValue(PROP_NBT_RECURSIVE)
                .getRawValue();
            boolean blacklist = properties.getValue(PROP_BLACKLIST)
                .getRawValue();
            IngredientPredicate<ItemStack, Integer> itemStackMatcher = TunnelItemHelpers
                .matchNbt(tag, subset, superset, requireNbt, recursive, blacklist, amount, exactAmount);
            return Triple.of(
                input.getLeft(),
                input.getMiddle(),
                ChanneledTargetInformation.of(itemStackMatcher, itemStackMatcher, slot));
        };
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, BlockState>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>> PROP_BLOCK_ITEMPREDICATE = input -> {
            IAspectProperties properties = input.getMiddle();
            ...
            ItemStack itemBlock = input.getRight() == null ? null
                : BlockHelpers.getItemStackFromBlockState(input.getRight());
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ValueTypeList.ValueList>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>> PROP_BLOCKLIST_ITEMPREDICATE = input -> {
            ValueTypeList.ValueList list = input.getRight();
            ...
            IngredientPredicate<ItemStack, Integer> itemStackMatcher = TunnelItemHelpers
                .matchBlocks(list.getRawValue(), true, false, true, false, blacklist, amount, exactAmount);
            int slot = properties.getValue(PROP_SLOT)
                .getRawValue();
            return Triple.of(
                input.getLeft(),
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ValueTypeOperator.ValueOperator>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>> PROP_BLOCKPREDICATE_ITEMPREDICATE = input -> {
            IOperator predicate = input.getRight()
                .getRawValue();
            if (predicate.getInputTypes().length == 1
                ...
                boolean exactAmount = false;
                IngredientPredicate<ItemStack, Integer> itemStackMatcher = TunnelItemHelpers
                    .matchPredicateBlock(input.getLeft(), predicate, amount, exactAmount);
                int slot = properties.getValue(PROP_SLOT)
                    .getRawValue();
                return Triple.of(
                    input.getLeft(),
                ...
                String current = ValueTypeOperator.getSignature(predicate);
                String expected = ValueTypeOperator
                    .getSignature(new IValueType[] { ValueTypes.OBJECT_BLOCK }, ValueTypes.BOOLEAN);
                throw new EvaluationException(
                    new LangHelpers.UnlocalizedString(L10NValues.ASPECT_ERROR_INVALIDTYPE, expected, current)
                        .localize());
            }
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>, IItemTarget> PROP_ITEMTARGET = input -> IItemTarget
    ...
    public static final class Fluid {
        ...
        public static final IAspectProperties PROPERTIES_RATECHECKSCRAFT = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                ...
                PROP_CHECK_NBT,
                PROP_CRAFT));
        public static final IAspectProperties PROPERTIES_RATECHECKSLIST = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                PROP_CHANNEL,
                PROP_ROUNDROBIN,
                PROP_BLACKLIST,
        ...
        static {
            ...
            PROPERTIES_RATECHECKSCRAFT.setValue(
                PROP_CHANNEL,
                ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
            ...
            PROPERTIES_RATECHECKSLIST.setValue(
                PROP_CHANNEL,
                ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, FluidStack>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<FluidStack, Integer>>> PROP_FLUIDSTACK_FLUIDPREDICATE = input -> {
            IAspectProperties properties = input.getMiddle();
            ...
            IngredientPredicate<FluidStack, Integer> ingredientPredicate = TunnelFluidHelpers
                .matchFluidStack(prototype, checkFluid, checkAmount, checkNbt, blacklist, exactAmount);
            return Triple.of(
                input.getLeft(),
                input.getMiddle(),
                ChanneledTargetInformation.of(ingredientPredicate, ingredientPredicate, -1));
        };
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ValueTypeList.ValueList>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<FluidStack, Integer>>> PROP_FLUIDSTACKLIST_FLUIDPREDICATE = input -> {
            ValueTypeList.ValueList<ValueObjectTypeFluidStack, ValueObjectTypeFluidStack.ValueFluidStack> list = input
                .getRight();
            ...
            boolean blacklist = properties.getValue(PROP_BLACKLIST)
                .getRawValue();
            IngredientPredicate<FluidStack, Integer> fluidStackMatcher = TunnelFluidHelpers
                .matchFluidStacks(list.getRawValue(), true, checkAmount, checkNbt, blacklist, rate, exactAmount);
            return Triple.of(
                input.getLeft(),
                input.getMiddle(),
                ChanneledTargetInformation.of(fluidStackMatcher, fluidStackMatcher, -1));
        };
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ValueTypeOperator.ValueOperator>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<FluidStack, Integer>>> PROP_FLUIDSTACKPREDICATE_FLUIDPREDICATE = input -> {
            IOperator predicate = input.getRight()
                .getRawValue();
            if (predicate.getInputTypes().length == 1
                ...
                boolean exactAmount = properties.getValue(PROP_EXACTAMOUNT)
                    .getRawValue();
                IngredientPredicate<FluidStack, Integer> fluidStackMatcher = TunnelFluidHelpers
                    .matchPredicate(input.getLeft(), predicate, rate, exactAmount);
                return Triple.of(
                    input.getLeft(),
                    input.getMiddle(),
                    ChanneledTargetInformation.of(fluidStackMatcher, fluidStackMatcher, -1));
                ...
                String current = ValueTypeOperator.getSignature(predicate);
                String expected = ValueTypeOperator
                    .getSignature(new IValueType[] { ValueTypes.OBJECT_FLUIDSTACK }, ValueTypes.BOOLEAN);
                throw new EvaluationException(
                    new LangHelpers.UnlocalizedString(L10NValues.ASPECT_ERROR_INVALIDTYPE, expected, current)
                        .localize());
            }
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, NBTTagCompound>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<FluidStack, Integer>>> PROP_NBT_FLUIDPREDICATE = input -> {
            ...
            boolean blacklist = properties.getValue(PROP_BLACKLIST)
                .getRawValue();
            IngredientPredicate<FluidStack, Integer> fluidStackMatcher = TunnelFluidHelpers
                .matchNbt(tag, subset, superset, requireNbt, recursive, blacklist, rate, exactAmount);
            return Triple.of(
                input.getLeft(),
                input.getMiddle(),
                ChanneledTargetInformation.of(fluidStackMatcher, fluidStackMatcher, -1));
        };
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<FluidStack, Integer>>, IFluidTarget> PROP_FLUIDTARGET = input -> IFluidTarget
            .ofCapabilityProvider(
                input.getRight()
                    .getTransfer(),
                input.getLeft(),
    ...
    public static final class World {
        ...
        public static final AspectBuilder<ValueObjectTypeBlock.ValueBlock, ValueObjectTypeBlock, Triple<PartTarget, IAspectProperties, ValueObjectTypeBlock.ValueBlock>> BUILDER_BLOCK_BASE = AspectWriteBuilders
            .getValue(AspectBuilder.forWriteType(ValueTypes.OBJECT_BLOCK))
            .withProperties(PROPERTIES_CHANNEL);
        ...
        public static final class Energy {
            ...
            public static final IAspectProperties PROPERTIES_ENTITY = new AspectProperties(
                ImmutableList
                    .<IAspectPropertyTypeInstance>of(PROP_CHANNEL, PROP_EXACTAMOUNT, World.PROPERTY_ENTITYINDEX));
            public static final IAspectProperties PROPERTIES_ENTITYCRAFT = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_EXACTAMOUNT,
            ...
            static {
                ...
                PROPERTIES_ENTITYCRAFT.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
            ...
            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Integer>, IEnergyTarget> PROP_ENTITY_ENERGYTARGET = input -> {
                PartTarget partTarget = input.getLeft();
                IAspectProperties properties = input.getMiddle();
                int amount = input.getRight();
                int entityIndex = properties.getValue(World.PROPERTY_ENTITYINDEX)
                    .getRawValue();
        ...
        public static final class Item {
            ...
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PICK_UP_NORATE = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_EXACTAMOUNT,
            ...
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_EXACTAMOUNT,
                    ...
                    PROP_PITCH));
            static {
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE.setValue(PROP_ROUNDROBIN, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE
                    .setValue(PROP_EXACTAMOUNT, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE.setValue(
                    TunnelAspectWriteBuilders.Item.PROP_CHECK_STACKSIZE,
                    ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_CHECK_DAMAGE, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_CHECK_NBT, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE
                    .setValue(PROP_IGNORE_PICK_UP_DELAY, ValueTypeBoolean.ValueBoolean.of(true));

                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                    .setValue(PROP_ROUNDROBIN, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                    .setValue(PROP_EXACTAMOUNT, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                    .setValue(PROP_DISPENSE, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                    .setValue(PROP_OFFSET_X, ValueTypeDouble.ValueDouble.of(0.5D));
                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                    .setValue(PROP_OFFSET_Y, ValueTypeDouble.ValueDouble.of(0.5D));
                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                    .setValue(PROP_OFFSET_Z, ValueTypeDouble.ValueDouble.of(0.5D));
                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                    .setValue(PROP_LIFESPAN, ValueTypeInteger.ValueInteger.of(6000));
                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                    .setValue(PROP_DELAY_BEFORE_PICKUP, ValueTypeInteger.ValueInteger.of(10));
                PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                    .setValue(PROP_VELOCITY, ValueTypeDouble.ValueDouble.of(0.1D));
            ...
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PICK_UP = PROPERTIES_ENTITYITEM_PICK_UP_NORATE
                .clone();
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PLACE_NORATE = PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                .clone();
            ...
            public static final IAspectProperties PROPERTIES_ENTITYITEMCRAFT_PLACE = PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS
                .clone();
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PICK_UP_NOCHECKS = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_EXACTAMOUNT,
            ...
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PICK_UP_NORATE_NOCHECKS = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    ...
                    PROP_EXACTAMOUNT,
                    PROP_IGNORE_PICK_UP_DELAY));
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PICK_UP_NBT = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLACKLIST,
            ...
            static {
                ...
                PROPERTIES_ENTITYITEM_PICK_UP_NOCHECKS.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE_NOCHECKS.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE_NOCHECKS
                    .setValue(PROP_ROUNDROBIN, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE_NOCHECKS
                    .setValue(PROP_EXACTAMOUNT, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PICK_UP_NORATE_NOCHECKS
                ...
                PROPERTIES_ENTITYITEM_PICK_UP_NBT.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_ENTITYITEM_PICK_UP_NBT
                    .setValue(PROP_IGNORE_PICK_UP_DELAY, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_ENTITYITEM_PICK_UP_NBT
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_RATE, ValueTypeInteger.ValueInteger.of(64));
                PROPERTIES_ENTITYITEM_PICK_UP_NBT
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_NBT_SUBSET, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_ENTITYITEM_PICK_UP_NBT
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_NBT_SUPERSET, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_ENTITYITEM_PICK_UP_NBT
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_NBT_REQUIRE, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_ENTITYITEM_PICK_UP_NBT.setValue(
                    TunnelAspectWriteBuilders.Item.PROP_NBT_RECURSIVE,
                    ValueTypeBoolean.ValueBoolean.of(true));

                PROPERTIES_ENTITYITEMCRAFT_PLACE.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                PROPERTIES_ENTITYITEMCRAFT_PLACE
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_RATE, ValueTypeInteger.ValueInteger.of(64));
                PROPERTIES_ENTITYITEMCRAFT_PLACE.setValue(
                    TunnelAspectWriteBuilders.Item.PROP_CHECK_STACKSIZE,
                    ValueTypeBoolean.ValueBoolean.of(false));
                ...
                PROPERTIES_ENTITYITEM_PLACE_NORATE.setValue(
                    TunnelAspectWriteBuilders.Item.PROP_CHECK_STACKSIZE,
                    ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PLACE_NORATE
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_CHECK_DAMAGE, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_ENTITYITEM_PLACE_NORATE
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_CHECK_NBT, ValueTypeBoolean.ValueBoolean.of(true));
                ...
                PROPERTIES_ENTITYITEM_PLACE_NBT
                    .setValue(TunnelAspectWriteBuilders.Item.PROP_NBT_REQUIRE, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_ENTITYITEM_PLACE_NBT.setValue(
                    TunnelAspectWriteBuilders.Item.PROP_NBT_RECURSIVE,
                    ValueTypeBoolean.ValueBoolean.of(true));
            }
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PICK_UPLIST = PROPERTIES_ENTITYITEM_PICK_UP
                .clone();
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PLACELIST = PROPERTIES_ENTITYITEMCRAFT_PLACE
                .clone();
            static {
            ...
            public static final IAspectProperties PROPERTIES_RATESLOTCHECKSCRAFT = TunnelAspectWriteBuilders.Item.PROPERTIES_RATESLOTCHECKSCRAFT
                .clone();
            public static final IAspectProperties PROPERTIES_NBT = TunnelAspectWriteBuilders.Item.PROPERTIES_NBT
                .clone();
            static {
            ...
            public static <T> IAspectValuePropagator<Triple<PartTarget, IAspectProperties, T>, Triple<PartTarget, IAspectProperties, T>> ignoreStackSize() {
                return input -> {
                    IAspectProperties aspectProperties = input.getMiddle()
                        .clone();
                    aspectProperties.setValue(
                        TunnelAspectWriteBuilders.Item.PROP_CHECK_STACKSIZE,
                        ValueTypeBoolean.ValueBoolean.of(false));
                    aspectProperties
                        .setValue(TunnelAspectWriteBuilders.Item.PROP_RATE, ValueTypeInteger.ValueInteger.of(1));
                    return Triple.of(input.getLeft(), aspectProperties, input.getRight());
                };
            }

            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Boolean>, IItemTarget> PROP_BOOLEAN_ITEMTARGET = input -> {
                IngredientPredicate<ItemStack, Integer> itemMatcher = input.getRight()
                    ? TunnelItemHelpers.matchAll(64, false)
                    : TunnelItemHelpers.MATCH_NONE;
                return IItemTarget.ofBlock(
                    itemMatcher,
                    input.getLeft(),
                    input.getMiddle(),
                    itemMatcher,
                    input.getMiddle()
                        .getValue(TunnelAspectWriteBuilders.Item.PROP_SLOT)
                        .getRawValue());
            };

            public static IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>, IItemTarget> newPropEntityItemItemTarget(
                ...
                return input -> {
                    ...
                    if (doImport) {
                        boolean ignorePickupDelay = properties.getValue(PROP_IGNORE_PICK_UP_DELAY)
                            .getRawValue();
                        itemStorage = new ItemHandlerWorldEntityImportWrapper(
                        ...
                        transfer = new TunnelTransferComposite(
                            input.getRight()
                                .getTransfer(),
                            new TunnelTransferEntities(
                                ((ItemHandlerWorldEntityImportWrapper) itemStorage).getEntities()));
                    } else {
                        double offsetX = properties.getValue(PROP_OFFSET_X)
                            .getRawValue();
                        double offsetY = properties.getValue(PROP_OFFSET_Y)
                            .getRawValue();
                        double offsetZ = properties.getValue(PROP_OFFSET_Z)
                            .getRawValue();
                        int lifespan = properties.getValue(PROP_LIFESPAN)
                            .getRawValue();
                        int delayBeforePickup = properties.getValue(PROP_DELAY_BEFORE_PICKUP)
                            .getRawValue();
                        ForgeDirection facing = center.getSide();
                        double velocity = properties.getValue(PROP_VELOCITY)
                            .getRawValue();
                        double yaw = properties.getValue(PROP_YAW)
                            .getRawValue();
                        double pitch = properties.getValue(PROP_PITCH)
                            .getRawValue();
                        boolean dispense = properties.getValue(PROP_DISPENSE)
                            .getRawValue();
                    ...
                    return IItemTarget
                        .ofStorage(transfer, network, partTarget, properties, itemStackMatcher, itemStorage, -1);
                };
            }

            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>, IItemTarget> PROP_ENTITYITEM_ITEMTARGET_IMPORT = newPropEntityItemItemTarget(
                true);
            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>, IItemTarget> PROP_ENTITYITEM_ITEMTARGET_EXPORT = newPropEntityItemItemTarget(
                false);

            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>, IItemTarget> PROP_ENTITY_ITEMTARGET = input -> {
                PartTarget partTarget = input.getLeft();
                IAspectProperties properties = input.getMiddle();
                IngredientPredicate<ItemStack, Integer> itemStackMatcher = input.getRight()
                    .getIngredientPredicate();
        ...
        public static final class Fluid {
            ...
            public static final IAspectProperties PROPERTIES_FLUIDCRAFT_UPDATE = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    ...
                    PROP_IGNORE_REPLACABLE,
                    PROP_CRAFT));
            public static final IAspectProperties PROPERTIES_FLUIDLIST_UPDATE = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLACKLIST,
                    ...
                    PROP_BLOCK_UPDATE,
                    PROP_IGNORE_REPLACABLE));
            public static final IAspectProperties PROPERTIES_FLUID = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_EMPTYISANY,
                    TunnelAspectWriteBuilders.Fluid.PROP_CHECK_NBT));
            public static final IAspectProperties PROPERTIES_FLUIDLIST = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLACKLIST,
                    TunnelAspectWriteBuilders.Fluid.PROP_CHECK_NBT));
            public static final IAspectProperties PROPERTIES_NBT_UPDATE = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_BLOCK_UPDATE,
                    PROP_IGNORE_REPLACABLE,
            ...
            public static final IAspectProperties PROPERTIES_RATECHECKSCRAFT = TunnelAspectWriteBuilders.Fluid.PROPERTIES_RATECHECKSCRAFT
                .clone();
            public static final IAspectProperties PROPERTIES_RATECHECKSLIST = TunnelAspectWriteBuilders.Fluid.PROPERTIES_RATECHECKSLIST
                .clone();
            ...
            static {
                ...
                PROPERTIES_FLUIDLIST_UPDATE.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_NBT_UPDATE.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_NBT_UPDATE
                    .setValue(TunnelAspectWriteBuilders.Fluid.PROP_NBT_SUBSET, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_NBT_UPDATE.setValue(
                    TunnelAspectWriteBuilders.Fluid.PROP_NBT_SUPERSET,
                    ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_NBT_UPDATE
                    .setValue(TunnelAspectWriteBuilders.Fluid.PROP_NBT_REQUIRE, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_NBT_UPDATE.setValue(
                    TunnelAspectWriteBuilders.Fluid.PROP_NBT_RECURSIVE,
                    ValueTypeBoolean.ValueBoolean.of(true));
            ...
            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Boolean>, IFluidTarget> PROP_BOOLEAN_FLUIDTARGET = input -> {
                IngredientPredicate<FluidStack, Integer> fluidStackPredicate = input.getRight()
                    ? TunnelFluidHelpers.matchAll(FluidHelpers.BUCKET_VOLUME, false)
                    : TunnelFluidHelpers.MATCH_NONE;
                return IFluidTarget
                    .ofCapabilityProvider(fluidStackPredicate, input.getLeft(), input.getMiddle(), fluidStackPredicate);
            };
            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, FluidStack>, IFluidTarget> PROP_FLUIDSTACK_FLUIDTARGET = input -> {
                IAspectProperties properties = input.getMiddle();
                boolean checkNbt = properties.getValue(TunnelAspectWriteBuilders.Fluid.PROP_CHECK_NBT)
                    .getRawValue();
                boolean blacklist = properties.getValue(PROP_BLACKLIST)
                    .getRawValue();
                ...
                IngredientPredicate<FluidStack, Integer> fluidStackPredicate = TunnelFluidHelpers
                    .matchFluidStack(prototype, checkFluid, false, checkNbt, blacklist, true);
                return IFluidTarget
                    .ofBlock(fluidStackPredicate, input.getLeft(), input.getMiddle(), fluidStackPredicate);
            };
            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ValueTypeList.ValueList>, IFluidTarget> PROP_FLUIDSTACKLIST_FLUIDTARGET = input -> {
                ValueTypeList.ValueList list = input.getRight();
                validateListValues(list, ValueTypes.OBJECT_FLUIDSTACK);
            ...
            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ValueTypeOperator.ValueOperator>, IFluidTarget> PROP_FLUIDSTACKPREDICATE_FLUIDTARGET = input -> {
                IOperator predicate = input.getRight()
                    .getRawValue();
                if (predicate.getInputTypes().length == 1
                    && ValueHelpers.correspondsTo(predicate.getInputTypes()[0], ValueTypes.OBJECT_FLUIDSTACK)
                    && ValueHelpers.correspondsTo(predicate.getOutputType(), ValueTypes.BOOLEAN)) {
                    IngredientPredicate<FluidStack, Integer> fluidStackPredicate = TunnelFluidHelpers
                        .matchPredicate(input.getLeft(), predicate, FluidHelpers.BUCKET_VOLUME, true);
                    return IFluidTarget
                        .ofBlock(fluidStackPredicate, input.getLeft(), input.getMiddle(), fluidStackPredicate);
                } else {
                    String current = ValueTypeOperator.getSignature(predicate);
            ...
            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, NBTTagCompound>, IFluidTarget> PROP_NBT_FLUIDTARGET = input -> {
                ...
                boolean superset = properties.getValue(TunnelAspectWriteBuilders.Fluid.PROP_NBT_SUPERSET)
                    .getRawValue();
                boolean requireNbt = properties.getValue(TunnelAspectWriteBuilders.Fluid.PROP_NBT_REQUIRE)
                    .getRawValue();
                boolean recursive = properties.getValue(TunnelAspectWriteBuilders.Fluid.PROP_NBT_RECURSIVE)
                    .getRawValue();
                boolean blacklist = properties.getValue(PROP_BLACKLIST)
                    .getRawValue();
                IngredientPredicate<FluidStack, Integer> fluidStackMatcher = TunnelFluidHelpers.matchNbt(
                    tag,
                    subset,
                    superset,
                    requireNbt,
            ...
            public static final IAspectValuePropagator<IFluidTarget, Void> PROP_FLUIDSTACK_EXPORT = input -> {
                PartPos target = input.getPartTarget()
                    .getTarget();
                ...
                if (pos.isLoaded() && input.getChanneledNetwork() != null) {
                    ...
                    TunnelFluidHelpers.placeFluids(
                        ...
                        input.getFluidStackMatcher(),
                        input.getProperties()
                            .getValue(PROP_BLOCK_UPDATE)
                            .getRawValue(),
                        input.getProperties()
                            .getValue(PROP_IGNORE_REPLACABLE)
                            .getRawValue(),
                        input.isCraftIfFailed());
                    input.postTransfer();
                }
            ...
            public static final IAspectValuePropagator<IFluidTarget, Void> PROP_FLUIDSTACK_IMPORT = input -> {
                PartPos target = input.getPartTarget()
                    .getTarget();
                final DimPos pos = target.getPos();
                if (pos.isLoaded() && input.getChanneledNetwork() != null) {
            ...
            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<FluidStack, Integer>>, IFluidTarget> PROP_ENTITY_FLUIDTARGET = input -> {
                PartTarget partTarget = input.getLeft();
                IAspectProperties properties = input.getMiddle();
                IngredientPredicate<FluidStack, Integer> fluidStackPredicate = input.getRight()
                    .getIngredientPredicate();
        ...
        public static final class Block {
            ...
            public static final IAspectProperties PROPERTIES_ITEM_PLACE_NOCHECKS = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLOCK_UPDATE,
                    PROP_HAND_RIGHT,
                    PROP_IGNORE_REPLACABLE));
            public static final IAspectProperties PROPERTIES_ITEMCRAFT_PLACE = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLACKLIST,
                    ...
                    PROP_IGNORE_REPLACABLE,
                    PROP_CRAFT));
            public static final IAspectProperties PROPERTIES_ITEM_PLACE_NBT = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLACKLIST,
                    ...
                    TunnelAspectWriteBuilders.Item.PROP_NBT_RECURSIVE));
            public static final IAspectProperties PROPERTIES_ITEM_PICK_UP_NOCHECKS = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLOCK_UPDATE,
            ...
            public static final IAspectProperties PROPERTIES_ITEM_PICK_UP = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLACKLIST,
                    ...
                    PROP_IGNORE_REPLACABLE,
                    PROP_BREAK_ON_NO_DROPS));
            public static final IAspectProperties PROPERTIES_ITEM_PICK_UP_NBT = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLACKLIST,
                    ...
                    TunnelAspectWriteBuilders.Item.PROP_NBT_REQUIRE,
                    TunnelAspectWriteBuilders.Item.PROP_NBT_RECURSIVE));
            public static final IAspectProperties PROPERTIES_BLOCK_PLACE = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLOCK_UPDATE,
                    PROP_HAND_RIGHT,
                    PROP_IGNORE_REPLACABLE));
            public static final IAspectProperties PROPERTIES_BLOCK_PICK_UP = new AspectProperties(
                ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLOCK_UPDATE,
            ...
            static {
                PROPERTIES_ITEM_PLACE_NOCHECKS.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_ITEM_PLACE_NOCHECKS
                    .setValue(PROP_IGNORE_REPLACABLE, ValueTypeBoolean.ValueBoolean.of(false));

                PROPERTIES_ITEMCRAFT_PLACE.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_ITEM_PLACE_NBT.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_ITEM_PICK_UP_NOCHECKS.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_ITEM_PICK_UP_NOCHECKS
                    .setValue(PROP_IGNORE_REPLACABLE, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ITEM_PICK_UP_NOCHECKS
                    .setValue(PROP_BREAK_ON_NO_DROPS, ValueTypeBoolean.ValueBoolean.of(true));

                PROPERTIES_ITEM_PICK_UP.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_ITEM_PICK_UP_NBT.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_BLOCK_PLACE.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                ...
                PROPERTIES_BLOCK_PICK_UP.setValue(
                    PROP_CHANNEL,
                    ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
            ...
            public static final IAspectValuePropagator<IItemTarget, Void> PROP_ITEMBLOCK_EXPORT = input -> {
                PartPos target = input.getPartTarget()
                    .getTarget();
                IItemNetwork itemNetwork = input.getChanneledNetwork();
                if (target.getPos()
                    .isLoaded() && itemNetwork != null) {
                    boolean blockUpdate = input.getProperties()
                        .getValue(PROP_BLOCK_UPDATE)
                        .getRawValue();
                    boolean ignoreReplacable = input.getProperties()
                        .getValue(PROP_IGNORE_REPLACABLE)
                        .getRawValue();
            ...
            public static final IAspectValuePropagator<IItemTarget, Void> PROP_ITEMBLOCK_IMPORT = input -> {
                PartPos target = input.getPartTarget()
                    .getTarget();
                IItemNetwork itemNetwork = input.getChanneledNetwork();
                if (target.getPos()
                    ...
                    boolean ignoreReplacable = input.getProperties()
                        ...
                        .getRawValue();
                    int fortune = 0;
                    boolean silkTouch = input.getProperties()
                        .getValue(PROP_SILK_TOUCH)
                        .getRawValue();
                    boolean breakOnNoDrops = input.getProperties()
                        .getValue(PROP_BREAK_ON_NO_DROPS)
                        .getRawValue();
    ...
    public static final class Player {
        ...
        public static final IAspectProperties PROPERTIES_CLICK_EMPTY = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                ...
                World.PROP_OFFSET_Y,
                World.PROP_OFFSET_Z));
        public static final IAspectProperties PROPERTIES_CLICK_SIMPLE = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                PROP_CHANNEL,
                PROP_ROUNDROBIN,
                PROP_RIGHT_CLICK,
                ...
                World.PROP_OFFSET_Y,
                World.PROP_OFFSET_Z));
        public static final IAspectProperties PROPERTIES_CLICK_NORATE = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                PROP_CHANNEL,
                PROP_ROUNDROBIN,
                PROP_RIGHT_CLICK,
                ...
                World.PROP_OFFSET_Y,
                World.PROP_OFFSET_Z));
        public static final IAspectProperties PROPERTIES_CLICK = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                PROP_CHANNEL,
                PROP_ROUNDROBIN,
                PROP_BLACKLIST,
                ...
                World.PROP_OFFSET_Y,
                World.PROP_OFFSET_Z));
        public static final IAspectProperties PROPERTIES_CLICKCRAFT = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(
                PROP_CHANNEL,
                PROP_ROUNDROBIN,
                PROP_BLACKLIST,
                ...
                World.PROP_OFFSET_Z));
        static {
            PROPERTIES_CLICK_EMPTY.setValue(
                PROP_CHANNEL,
                ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
            ...
            PROPERTIES_CLICK_SIMPLE.setValue(
                PROP_CHANNEL,
                ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
            ...
            PROPERTIES_CLICK_NORATE.setValue(
                PROP_CHANNEL,
                ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
            ...
            PROPERTIES_CLICKCRAFT.setValue(
                PROP_CHANNEL,
                ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
        ...
        static {
            ...
            PROPERTIES_CLICK_NBT
                .setValue(TunnelAspectWriteBuilders.Item.PROP_NBT_REQUIRE, ValueTypeBoolean.ValueBoolean.of(true));
            PROPERTIES_CLICK_NBT
                .setValue(TunnelAspectWriteBuilders.Item.PROP_NBT_RECURSIVE, ValueTypeBoolean.ValueBoolean.of(true));
        }

        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Boolean>, Void> PROP_CLICK_EMPTY = input -> {
            if (input.getRight()) {
                PartTarget partTarget = input.getLeft();
                IAspectProperties properties = input.getMiddle();
                boolean rightClick = properties.getValue(PROP_RIGHT_CLICK)
                    .getRawValue();
                boolean continuousClick = properties.getValue(PROP_CONTINUOUS_CLICK)
                    .getRawValue();
                boolean sneak = properties.getValue(PROP_SNEAK)
                    .getRawValue();
                int entityIndex = properties.getValue(World.PROPERTY_ENTITYINDEX)
                    .getRawValue();
                double offsetX = properties.getValue(World.PROP_OFFSET_X)
                    .getRawValue();
                double offsetY = properties.getValue(World.PROP_OFFSET_Y)
                    .getRawValue();
                double offsetZ = properties.getValue(World.PROP_OFFSET_Z)
                    .getRawValue();
                int channel = properties.getValue(PROP_CHANNEL)
                    .getRawValue();
                ...
                PartPos target = partTarget.getTarget();
                INetwork network = IChanneledTarget.getNetworkChecked(center);
                PartStatePlayerSimulator partState = (PartStatePlayerSimulator) PartHelpers.getPart(center)
                    .getState();

                IIngredientComponentStorage<ItemStack, Integer> storage = new ItemStoragePlayerWrapper(
                    partState.getPlayer(),
                    (WorldServer) target.getPos()
                        .getWorld(),
                    target.getPos()
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<ItemStack, Integer>>, IItemTarget> PROP_ITEMTARGET_CLICK = input -> {
            PartTarget partTarget = input.getLeft();
            IAspectProperties properties = input.getMiddle();
            IngredientPredicate<ItemStack, Integer> itemStackMatcher = input.getRight()
                .getIngredientPredicate();
            boolean rightClick = input.getMiddle()
                .getValue(PROP_RIGHT_CLICK)
                .getRawValue();
            boolean continuousClick = properties.getValue(PROP_CONTINUOUS_CLICK)
                .getRawValue();
            boolean sneak = properties.getValue(PROP_SNEAK)
    ...
    public static <N extends IPositionedAddonsNetwork, T> IAspectWriteActivator createPositionedNetworkAddonActivator(
        final Supplier<Capability<N>> networkCapability, final Capability<T> targetCapability) {
    ...
    public static <N extends IPositionedAddonsNetwork, T> IAspectWriteDeactivator createPositionedNetworkAddonDeactivator(
        final Supplier<Capability<N>> networkCapability, final Capability<T> targetCapability) {
