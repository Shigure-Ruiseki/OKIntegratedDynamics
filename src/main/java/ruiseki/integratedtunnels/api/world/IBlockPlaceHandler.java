...
public interface IBlockPlaceHandler {
     ...
     */
    public boolean shouldApply(ItemStack itemStack, World world, BlockPos pos, ForgeDirection side, float hitX,
        float hitY, float hitZ, EntityPlayer player);
     ...
     * @param player    The placing player.
     */
    public void placeBlock(ItemStack itemStack, World world, BlockPos pos, ForgeDirection side, float hitX, float hitY,
        float hitZ, EntityPlayer player);
