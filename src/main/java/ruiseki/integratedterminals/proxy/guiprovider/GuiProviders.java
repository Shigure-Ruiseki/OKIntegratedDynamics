...
public class GuiProviders {
    ...
    public static int ID_GUI_TERMINAL_STORAGE_CRAFTNG_OPTION_AMOUNT_PART;
    public static IGuiContainerProvider GUI_TERMINAL_STORAGE_CRAFTNG_OPTION_AMOUNT_PART;
    ...
    public static void register() {
        IntegratedTerminals._instance.getGuiHandler()
            .registerGUI(
                GUI_TERMINAL_STORAGE_CRAFTNG_OPTION_AMOUNT_PART = new GuiProviderTerminalStorageCraftingOptionAmountPart(
                    ID_GUI_TERMINAL_STORAGE_CRAFTNG_OPTION_AMOUNT_PART = Helpers
        ...
        IntegratedTerminals._instance.getGuiHandler()
            .registerGUI(
                GUI_TERMINAL_STORAGE_CRAFTNG_OPTION_AMOUNT_ITEM = new GuiProviderTerminalStorageCraftingOptionAmountItem(
                    ID_GUI_TERMINAL_STORAGE_CRAFTNG_OPTION_AMOUNT_ITEM = Helpers
                        .getNewId(IntegratedTerminals._instance, Helpers.IDType.GUI),
                    IntegratedTerminals._instance),
        ...
        IntegratedTerminals._instance.getGuiHandler()
            .registerGUI(
                GUI_TERMINAL_STORAGE_CRAFTNG_PLAN_ITEM = new GuiProviderTerminalStorageCraftingPlanItem(
                    ID_GUI_TERMINAL_STORAGE_CRAFTNG_PLAN_ITEM = Helpers
                        .getNewId(IntegratedTerminals._instance, Helpers.IDType.GUI),
                    IntegratedTerminals._instance),
                ExtendedGuiHandler.CRAFTING_PLAN_ITEM);

//        IntegratedTerminals._instance.getGuiHandler()
//            .registerGUI(
//                GUI_TERMINAL_CRAFTING_JOBS_PLAN_ITEM = new GuiProviderTerminalCraftingJobsPlan(
//                    ID_GUI_TERMINAL_CRAFTING_JOBS_PLAN_ITEM = Helpers
//                        .getNewId(IntegratedTerminals._instance, Helpers.IDType.GUI),
//                    IntegratedTerminals._instance),
//                ExtendedGuiHandler.CRAFTING_PLAN_ITEM);
