 ...
 *
 */
public class TerminalStorageIngredientOpenCraftingJobAmountGuiPacket<T, M, L>
    extends TerminalStorageIngredientCraftingOptionDataPacketAbstract<T, M, L> {
    ...
    public void actionServer(World world, EntityPlayerMP player) {
        ...
        craftingJobGuiData.getLocation()
            .openContainerCraftingOptionAmount(craftingJobGuiData, world, player);
    }
}
