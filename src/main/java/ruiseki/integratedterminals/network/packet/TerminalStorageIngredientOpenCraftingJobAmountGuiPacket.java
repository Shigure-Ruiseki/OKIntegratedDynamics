 ...
 *
 */
public class TerminalStorageIngredientOpenCraftingJobAmountGuiPacket<T, M>
    ...
    public void actionServer(World world, EntityPlayerMP player) {
        ...
        IntegratedTerminals._instance.getGuiHandler()
            .setTemporaryData(ExtendedGuiHandler.CRAFTING_OPTION, Pair.of(data.getSide(), data)); // Pass the side as
                                                                                                  // extra data to the
                                                                                                  // gui
