...
public class GuiCraftingPlanToggler {
    ...
    public GuiCraftingPlanToggler(Supplier<ITerminalCraftingPlan> craftingPlanSupplier,
        Supplier<ITerminalCraftingPlanFlat> craftingPlanFlatSupplier, Runnable initPlanTree, Runnable initPlanFlat,
        Runnable deinit) {
        ...
        if (this.craftingPlanDisplayMode == null) {
            if (this.craftingPlanFlatSupplier.get() != null) {
                if (this.craftingPlanSupplier.get() == null) {
                    ...
                    this.craftingPlanDisplayMode = GeneralConfig.terminalStorageDefaultToCraftingPlanTree
                        ? CraftingPlanDisplayMode.TREE
                        : CraftingPlanDisplayMode.FLAT;
                }
            } else {
                if (this.craftingPlanSupplier.get() == null) {
