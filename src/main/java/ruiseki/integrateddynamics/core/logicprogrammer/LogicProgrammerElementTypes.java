...
public class LogicProgrammerElementTypes {
    ...
    public static final ILogicProgrammerElementTypeRegistry REGISTRY = IntegratedDynamics._instance.getRegistryManager()
        .getRegistry(ILogicProgrammerElementTypeRegistry.class);
    ...
    public static final ValueTypeOperatorElementType OPERATOR_ELEMENT_TYPE = REGISTRY
        .addType(new ValueTypeOperatorElementType());
    public static final ValueObjectTypeBlockElementType OBJECT_BLOCK_TYPE = REGISTRY
        .addType(new ValueObjectTypeBlockElementType());
    public static final ValueObjectTypeItemStackElementType OBJECT_ITEMSTACK_TYPE = REGISTRY
        .addType(new ValueObjectTypeItemStackElementType());
    public static final ValueObjectTypeFluidStackElementType OBJECT_FLUIDSTACK_TYPE = REGISTRY
        .addType(new ValueObjectTypeFluidStackElementType());
