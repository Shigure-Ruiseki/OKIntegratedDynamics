...
public class ValueTypeOperatorLPElementRenderPattern extends
    GuiElementValueTypeDropdownListRenderPattern<IOperator, RenderPattern, GuiLogicProgrammerBase, ContainerLogicProgrammerBase>
    implements IRenderPatternValueTypeTooltip {

    private boolean renderTooltip = true;

    public ValueTypeOperatorLPElementRenderPattern(ValueTypeOperatorLPElement element, int baseX, int baseY,
        int maxWidth, int maxHeight, GuiLogicProgrammerBase gui, ContainerLogicProgrammerBase container) {
