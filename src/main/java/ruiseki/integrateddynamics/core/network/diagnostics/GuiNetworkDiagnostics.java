...
public class GuiNetworkDiagnostics extends JFrame {
                ...
                public void run() {
                    synchronized (networkDataParts) {
                        ...
                        if (tableParts == null) {
                            ...
                            tableParts.getColumnModel()
                                .removeColumn(tableParts.getColumn("_id"));
                            ...
                            tableObservers.getColumnModel()
                                .removeColumn(tableObservers.getColumn("_id"));
    ...
    protected static ObservablePartData getPartDataFromRow(int row) {
        ...
        int internalId = (int) tableParts.getModel()
            .getValueAt(tableParts.convertRowIndexToModel(row), 7);
    ...
    protected static ObservableObserverData getObserverDataFromRow(int row) {
        ...
        int internalId = (int) tableObservers.getModel()
            .getValueAt(tableObservers.convertRowIndexToModel(row), 6);
        if (internalId < data.length) {
