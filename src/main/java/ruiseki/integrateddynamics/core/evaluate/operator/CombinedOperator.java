...
public class CombinedOperator extends OperatorBase {
    ...
    public static class Pipe extends OperatorsFunction {
         ...
         */
        public static IValue pipeVariablesToOperators(IVariable[] allVariables, IOperator[] operators)
        ...
        public static CombinedOperator asOperator(OperatorsFunction function, String symbol, String operatorName,
            final IOperator... operators) {
            ...
            if (originalInputTypes.length < 2) {
                throw new EvaluationException(
                    LangHelpers.localize(
                        L10NValues.OPERATOR_ERROR_WRONGINPUTLENGTHVIRTIUAL,
                        LangHelpers.localize(Operators.OPERATOR_FLIP.getUnlocalizedName()),
                        LangHelpers.localize(operator.getUnlocalizedName()),
                        originalInputTypes.length,
                        2));
            }
