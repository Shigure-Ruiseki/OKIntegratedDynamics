...
public class PositionedOperatorRecipeHandlerRecipesByOutput<T extends IValueType<V>, V extends IValue>
    ...
    public PositionedOperatorRecipeHandlerRecipesByOutput(DimPos pos, ForgeDirection side) {
    ...
    public static class Function extends PositionedOperatorRecipeHandler.Function {
        ...
        protected Cache<Pair<Pair<DimPos, ForgeDirection>, ValueObjectTypeIngredients.ValueIngredients>, ValueTypeList.ValueList> getCache() {
            return CACHE;
        }
