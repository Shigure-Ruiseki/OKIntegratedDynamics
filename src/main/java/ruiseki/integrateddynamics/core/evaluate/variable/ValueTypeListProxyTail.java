...
public class ValueTypeListProxyTail<T extends IValueType<V>, V extends IValue> extends ValueTypeListProxyBase<T, V> {
    ...
    public static class Factory implements
        IValueTypeListProxyFactoryTypeRegistry.IProxyFactory<IValueType<IValue>, IValue, ValueTypeListProxyTail<IValueType<IValue>, IValue>> {
        ...
        @Override
        public String serialize(ValueTypeListProxyTail<IValueType<IValue>, IValue> values)
        ...
        @Override
        public ValueTypeListProxyTail<IValueType<IValue>, IValue> deserialize(String data)
            throws IValueTypeListProxyFactoryTypeRegistry.SerializationException {
            try {
