...
public class ValueCastMappings {
    ...
    private static IValueCastRegistry constructRegistry() {
        ...
        if (MinecraftHelpers.isModdedEnvironment()) {
            return IntegratedDynamics._instance.getRegistryManager()
                .getRegistry(IValueCastRegistry.class);
        } else {
    ...
    public static void load() {
        REGISTRY.register(
            ValueTypes.INTEGER,
            ValueTypes.DOUBLE,
            new IValueCastRegistry.IMapping<ValueTypeInteger, ValueTypeDouble, ValueTypeInteger.ValueInteger, ValueTypeDouble.ValueDouble>() {
        ...
        REGISTRY.register(
            ValueTypes.INTEGER,
            ValueTypes.LONG,
            new IValueCastRegistry.IMapping<ValueTypeInteger, ValueTypeLong, ValueTypeInteger.ValueInteger, ValueTypeLong.ValueLong>() {
        ...
        REGISTRY.register(
            ValueTypes.DOUBLE,
            ValueTypes.INTEGER,
            new IValueCastRegistry.IMapping<ValueTypeDouble, ValueTypeInteger, ValueTypeDouble.ValueDouble, ValueTypeInteger.ValueInteger>() {
        ...
        REGISTRY.register(
            ValueTypes.DOUBLE,
            ValueTypes.LONG,
            new IValueCastRegistry.IMapping<ValueTypeDouble, ValueTypeLong, ValueTypeDouble.ValueDouble, ValueTypeLong.ValueLong>() {
        ...
        REGISTRY.register(
            ValueTypes.LONG,
            ValueTypes.INTEGER,
            new IValueCastRegistry.IMapping<ValueTypeLong, ValueTypeInteger, ValueTypeLong.ValueLong, ValueTypeInteger.ValueInteger>() {
        ...
        REGISTRY.register(
            ValueTypes.LONG,
            ValueTypes.DOUBLE,
            new IValueCastRegistry.IMapping<ValueTypeLong, ValueTypeDouble, ValueTypeLong.ValueLong, ValueTypeDouble.ValueDouble>() {
