...
public class ValueTypeLightLevels {
    ...
    private static IValueTypeLightLevelRegistry constructRegistry() {
        ...
        if (MinecraftHelpers.isModdedEnvironment()) {
            return IntegratedDynamics._instance.getRegistryManager()
                .getRegistry(IValueTypeLightLevelRegistry.class);
        } else {
    ...
    public static void load() {
        REGISTRY.register(
            ValueTypes.INTEGER,
            new IValueTypeLightLevelRegistry.ILightLevelCalculator<ValueTypeInteger.ValueInteger>() {
        ...
        REGISTRY.register(
            ValueTypes.BOOLEAN,
            new IValueTypeLightLevelRegistry.ILightLevelCalculator<ValueTypeBoolean.ValueBoolean>() {
