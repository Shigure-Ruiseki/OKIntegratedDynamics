package ruiseki.integrateddynamics.core.evaluate.build;
...
public class OperatorBuilder<O> {
    ...
    protected OperatorBuilder(String symbol, String operatorName, IValueType[] inputTypes, IValueType outputType,
        OperatorBase.IFunction function, IConfigRenderPattern renderPattern, String modId, List<String> kinds,
        IConditionalOutputTypeDeriver conditionalOutputTypeDeriver, ITypeValidator typeValidator,
        List<IOperatorValuePropagator> valuePropagators) {
        this.symbol = symbol;
    ...
    public OperatorBuilder<O> inputTypes(int length, IValueType defaultType) {
        return new OperatorBuilder<>(
            symbol,
            operatorName,
            OperatorBase.constructInputVariables(length, defaultType),
            outputType,
            function,
            renderPattern,
            modId,
    ...
    public <O2> OperatorBuilder<O2> handle(IOperatorValuePropagator<O, O2> valuePropagator) {
        ...
        return new OperatorBuilder<>(
            ...
            conditionalOutputTypeDeriver,
            typeValidator,
            Helpers.joinList(valuePropagators, valuePropagator));
    }
    ...
    private static class Built extends OperatorBase {
        ...
        protected Built(OperatorBuilder operatorBuilder) {
            super(
                Objects.requireNonNull(operatorBuilder.symbol),
        ...
        public LangHelpers.UnlocalizedString validateTypes(IValueType[] input) {
            return typeValidator != null ? typeValidator.validateTypes(this, input) : super.validateTypes(input);
        }
    }
