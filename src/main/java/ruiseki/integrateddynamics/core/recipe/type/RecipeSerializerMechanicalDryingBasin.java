...
public class RecipeSerializerMechanicalDryingBasin implements IRecipeSerializer<RecipeMechanicalDryingBasin> {
    ...
    @Nullable
    @Override
    public RecipeMechanicalDryingBasin fromNetwork(ResourceLocation recipeId, ExtendedBuffer buffer)
        throws IOException {
        // Input
    ...
    @Override
    public void toNetwork(ExtendedBuffer buffer, RecipeMechanicalDryingBasin recipe) throws IOException {
        // Input
