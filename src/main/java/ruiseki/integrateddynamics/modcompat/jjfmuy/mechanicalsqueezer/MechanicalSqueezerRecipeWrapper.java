...
public class MechanicalSqueezerRecipeWrapper implements IRecipeWrapper {

    private final RecipeMechanicalSqueezer recipe;

    public MechanicalSqueezerRecipeWrapper(RecipeMechanicalSqueezer recipe) {
        this.recipe = recipe;
    }
    ...
    public void getIngredients(IIngredients ingredients) {
        ...
        if (recipe.getOutputItems() != null && !recipe.getOutputItems()
            ...
            for (RecipeMechanicalSqueezer.ItemStackChance stackChance : recipe.getOutputItems()) {
