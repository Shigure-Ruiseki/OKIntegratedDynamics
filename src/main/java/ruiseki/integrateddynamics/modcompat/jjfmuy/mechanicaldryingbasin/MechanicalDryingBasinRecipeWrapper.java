package ruiseki.integrateddynamics.modcompat.jjfmuy.mechanicaldryingbasin;
...
public class MechanicalDryingBasinRecipeWrapper implements IRecipeWrapper {

    private final RecipeMechanicalDryingBasin recipe;

    public MechanicalDryingBasinRecipeWrapper(RecipeMechanicalDryingBasin recipe) {
        this.recipe = recipe;
    }
