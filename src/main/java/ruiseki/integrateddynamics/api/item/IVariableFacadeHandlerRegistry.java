...
public interface IVariableFacadeHandlerRegistry extends IRegistry {
     ...
     *
     * @param generateId            If a new id should be generated. Otherwise the previous facade id will be used or -1
     *                              if non existing.
     * @param itemStack             The itemstack to write to.
     * @param variableFacadeHandler The variable facade handler.
     ...
     * @param <F> The variable facade type.
     */
    public <F extends IVariableFacade> F writeVariableFacade(boolean generateId, ItemStack itemStack,
        IVariableFacadeHandler<F> variableFacadeHandler, IVariableFacadeFactory<F> variableFacadeFactory);
