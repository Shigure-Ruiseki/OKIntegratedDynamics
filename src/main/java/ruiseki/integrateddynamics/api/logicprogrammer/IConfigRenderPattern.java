...
public interface IConfigRenderPattern {
    ...
    public static class Base implements IConfigRenderPattern {
        ...
        public Base(int width, int height, Pair<Integer, Integer>[] slotPositions,
            Pair<Integer, Integer> symbolPosition) {
            this.width = width;
            this.height = height;
    ...
    public static final IConfigRenderPattern NONE_CANVAS_WIDE = new IConfigRenderPattern.Base(
        158,
        89,
        new Pair[0],
        null);
    public static final IConfigRenderPattern NONE_CANVAS = new IConfigRenderPattern.Base(136, 89, new Pair[0], null);
    public static final IConfigRenderPattern SINGLE_SLOT = new IConfigRenderPattern.Base(
        22,
        22,
        new Pair[] { Pair.of(2, 2) },
        null);
    public static final IConfigRenderPattern RECIPE = new IConfigRenderPattern.Base(
        136,
        89,
        new Pair[] {
            // Items in
            Pair.of(2, 2), Pair.of(20, 2), Pair.of(38, 2), Pair.of(2, 20), Pair.of(20, 20), Pair.of(38, 20),
            Pair.of(2, 38), Pair.of(20, 38), Pair.of(38, 38),
            // Fluid in
            Pair.of(2, 58),
            // Items out
            Pair.of(100, 2), Pair.of(100, 20), Pair.of(100, 38),
            // Fluid out
            Pair.of(82, 58), },
        null);
    public static final IConfigRenderPattern INFIX = new IConfigRenderPattern.Base(
        100,
        22,
        new Pair[] { Pair.of(2, 2), Pair.of(80, 2) },
        Pair.of(50, 2));
    public static final IConfigRenderPattern INFIX_LONG = new IConfigRenderPattern.Base(
        120,
        22,
        new Pair[] { Pair.of(2, 2), Pair.of(100, 2) },
        Pair.of(59, 2));
    public static final IConfigRenderPattern INFIX_VERYLONG = new IConfigRenderPattern.Base(
        140,
        22,
        new Pair[] { Pair.of(2, 2), Pair.of(120, 2) },
        Pair.of(69, 2));
    public static final IConfigRenderPattern PREFIX_1 = new IConfigRenderPattern.Base(
        40,
        22,
        new Pair[] { Pair.of(20, 2) },
        Pair.of(10, 2));
    public static final IConfigRenderPattern PREFIX_1_LONG = new IConfigRenderPattern.Base(
        100,
        22,
        new Pair[] { Pair.of(80, 2) },
        Pair.of(40, 2));
    public static final IConfigRenderPattern INFIX_2 = new IConfigRenderPattern.Base(
        ...
        Pair.of(50, 2));
    public static final IConfigRenderPattern INFIX_2_LONG = new IConfigRenderPattern.Base(
        140,
        22,
        new Pair[] { Pair.of(2, 2), Pair.of(100, 2), Pair.of(120, 2) },
        Pair.of(60, 2));
    public static final IConfigRenderPattern INFIX_2_VERYLONG = new IConfigRenderPattern.Base(
        160,
        22,
        new Pair[] { Pair.of(2, 2), Pair.of(130, 2), Pair.of(140, 2) },
        Pair.of(70, 2));
    ...
    public static final IConfigRenderPattern PREFIX_2_LONG = new IConfigRenderPattern.Base(
        120,
        22,
        new Pair[] { Pair.of(80, 2), Pair.of(100, 2) },
        Pair.of(40, 2));
    public static final IConfigRenderPattern INFIX_3 = new IConfigRenderPattern.Base(
        ...
        Pair.of(45, 2));
    public static final IConfigRenderPattern PREFIX_3 = new IConfigRenderPattern.Base(
        120,
        22,
    ...
    public static final IConfigRenderPattern PREFIX_3_LONG = new IConfigRenderPattern.Base(
        140,
        22,
        new Pair[] { Pair.of(80, 2), Pair.of(100, 2), Pair.of(120, 2) },
        Pair.of(40, 2));
    public static final IConfigRenderPattern SUFFIX_1 = new IConfigRenderPattern.Base(
        40,
        22,
        new Pair[] { Pair.of(6, 2) },
        Pair.of(31, 2));
    public static final IConfigRenderPattern SUFFIX_1_LONG = new IConfigRenderPattern.Base(
        120,
        22,
        new Pair[] { Pair.of(2, 2) },
        Pair.of(70, 2));
