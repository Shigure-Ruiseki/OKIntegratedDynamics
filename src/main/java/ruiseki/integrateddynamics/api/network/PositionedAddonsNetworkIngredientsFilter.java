...
public class PositionedAddonsNetworkIngredientsFilter<T> {
     ...
     *         If this method returns true, then all insertions and/or extractions will be allowed when their respective
     *         application is disabled.
     *         If this method returns false, then no insertions and/or extractions will be allowed when their respective
     *         application is disabled.
     */
