...
public class AspectWriteBuilders {
    ...
    // --------------- Value type builders ---------------
    public static final AspectBuilder<ValueTypeBoolean.ValueBoolean, ValueTypeBoolean, Triple<PartTarget, IAspectProperties, ValueTypeBoolean.ValueBoolean>> BUILDER_BOOLEAN = getValue(
    ...
    public static final AspectBuilder<ValueTypeString.ValueString, ValueTypeString, Triple<PartTarget, IAspectProperties, ValueTypeString.ValueString>> BUILDER_STRING = getValue(
        AspectBuilder.forWriteType(ValueTypes.STRING));
    public static final AspectBuilder<ValueTypeList.ValueList, ValueTypeList, Triple<PartTarget, IAspectProperties, ValueTypeList.ValueList>> BUILDER_LIST = getValue(
    ...
    public static final class Audio {
        ...
        public static final IAspectPropertyTypeInstance<ValueTypeDouble, ValueTypeDouble.ValueDouble> PROP_FREQUENCY = new AspectPropertyTypeInstance<>(
            ...
            AspectReadBuilders.VALIDATOR_DOUBLE_POSITIVE);
        public static final IAspectPropertyTypeInstance<ValueTypeInteger, ValueTypeInteger.ValueInteger> PROP_RANGE = new AspectPropertyTypeInstance<>(
            ValueTypes.INTEGER,
        ...
        public static final IAspectProperties PROPERTIES_TEXT = new AspectProperties(
            ImmutableList.<IAspectPropertyTypeInstance>of(PROP_RANGE));
        static {
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Pair<NoteBlockEvent.Instrument, Integer>>, Void> PROP_SET = new IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Pair<NoteBlockEvent.Instrument, Integer>>, Void>() {
            ...
            public Void getOutput(
                Triple<PartTarget, IAspectProperties, Pair<NoteBlockEvent.Instrument, Integer>> input) {
                ...
                int eventID = input.getRight()
                    .getLeft()
                    .ordinal();
                int eventParam = input.getRight()
                    .getRight();
                if (eventParam >= 0 && eventParam <= 24) {
                    World world = input.getLeft()
                        .getTarget()
                        .getPos()
                        .getWorld();
                    NoteBlockEvent.Play e = new NoteBlockEvent.Play(
                        world,
                        pos.getX(),
                        pos.getY(),
                        pos.getZ(),
                        pos.getBlockMetadata(world),
                        eventParam,
                        eventID);
                    if (!net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(e)) {
                        float f = (float) Math.pow(2.0D, (double) (eventParam - 12) / 12.0D);
                        float volume = (float) properties.getValue(PROP_VOLUME)
                            .getRawValue();
                        IntegratedDynamics.proxy.sendSoundMinecraft(
                            (double) pos.getX() + 0.5D,
                            (double) pos.getY() + 0.5D,
                            (double) pos.getZ() + 0.5D,
                            "note." + getInstrument(eventID),
                            volume,
                            f);
                    }
                }
        ...
        public static IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Integer>, Triple<PartTarget, IAspectProperties, Pair<NoteBlockEvent.Instrument, Integer>>> propWithInstrument(
            ...
            return new IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Integer>, Triple<PartTarget, IAspectProperties, Pair<NoteBlockEvent.Instrument, Integer>>>() {
                ...
                @Override
                public Triple<PartTarget, IAspectProperties, Pair<NoteBlockEvent.Instrument, Integer>> getOutput(
                    Triple<PartTarget, IAspectProperties, Integer> input) throws EvaluationException {
        ...
        public static final AspectBuilder<ValueTypeInteger.ValueInteger, ValueTypeInteger, Triple<PartTarget, IAspectProperties, Integer>> BUILDER_INTEGER_INSTRUMENT = BUILDER_INTEGER
            .appendKind("instrument")
            .withProperties(PROPERTIES_NOTE);
        public static final AspectBuilder<ValueTypeString.ValueString, ValueTypeString, Triple<PartTarget, IAspectProperties, String>> BUILDER_STRING = AspectWriteBuilders.BUILDER_STRING
            .appendKind("audio")
            .handle(PROP_GET_STRING);
    ...
    public static final class Effect {
        ...
        public static final AspectBuilder<ValueTypeDouble.ValueDouble, ValueTypeDouble, Triple<PartTarget, IAspectProperties, Double>> BUILDER_DOUBLE = AspectWriteBuilders.BUILDER_DOUBLE
            .appendKind("effect")
            .handle(PROP_GET_DOUBLE);
        public static final AspectBuilder<ValueTypeDouble.ValueDouble, ValueTypeDouble, Triple<PartTarget, IAspectProperties, Double>> BUILDER_DOUBLE_PARTICLE = BUILDER_DOUBLE
            .withProperties(PROPERTIES_PARTICLE);
