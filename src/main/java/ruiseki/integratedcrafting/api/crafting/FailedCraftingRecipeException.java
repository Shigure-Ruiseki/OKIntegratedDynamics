...
public class FailedCraftingRecipeException extends Exception {
    ...
    public String getMessage() {
        return String.format(
            "Could craft the recipe %s (with %s missing, and %s stored, and %s partial), with missing sub-recipes: %s",
            getRecipe(),
            getQuantityMissing(),
    ...
    public boolean equals(Object obj) {
        ...
        return this.getRecipe()
            .equals(that.getRecipe()) && this.getQuantityMissing() == that.getQuantityMissing()
