...
public class CraftingJobDependencyGraph {
    ...
    public CraftingJobDependencyGraph(Int2ObjectMap<CraftingJob> craftingJobs,
        Int2ObjectMap<IntCollection> dependencies, Int2ObjectMap<IntCollection> dependents) {
    ...
    public void onCraftingJobFinished(CraftingJob craftingJob, boolean validateDependencies) {
        ...
        craftingJob.getDependentCraftingJobs()
            .clear();
        ...
        if (removed != null) {
            ...
            while (removedIt.hasNext()) {
                ...
                craftingJobs.get(dependent)
                    .getDependencyCraftingJobs()
                    .rem(craftingJob.getId());
    ...
    public void mergeCraftingJobs(CraftingJob target, CraftingJob mergee, boolean markMergeeAsFinished) {
        ...
        target.setIngredientsStorage(
            CraftingHelpers.mergeMixedIngredients(target.getIngredientsStorage(), mergee.getIngredientsStorage()));
    ...
    public static NBTTagCompound serialize(CraftingJobDependencyGraph graph) {
        ...
        for (CraftingJob craftingJob : graph.getCraftingJobs()) {
            ...
            if (intCollection != null) {
                dependencies
                    .setTag(Integer.toString(craftingJob.getId()), new NBTTagIntArray(intCollection.toIntArray()));
            }
        }
    ...
    public static CraftingJobDependencyGraph deserialize(NBTTagCompound tag) {
        ...
        for (String key : dependenciesTag.func_150296_c()) {
        ...
        for (String key : dependentsTag.func_150296_c()) {
            int id = Integer.parseInt(key);
