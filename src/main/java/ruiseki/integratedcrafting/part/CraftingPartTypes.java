...
public class CraftingPartTypes {
    ...
    public static final PartTypeInterfaceCraftingAttuned INTERFACE_CRAFTING_ATTUNED = REGISTRY
        .register(new PartTypeInterfaceCraftingAttuned("interface_crafting_attuned"));
