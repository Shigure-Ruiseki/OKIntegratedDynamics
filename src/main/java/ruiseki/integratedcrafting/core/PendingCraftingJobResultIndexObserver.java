...
public class PendingCraftingJobResultIndexObserver<T, M> implements IIngredientChannelInsertPreConsumer<T> {
     ...
     */
    public IIngredientChannelInsertPreConsumer.Result<T> addIngredient(T instance, T unclaimed, int channel,
        boolean simulate) {
                                ...
                                while (extractedQuantityToAssign > 0 && dependentJobs.hasNext()) {
                                    ...
                                    if (dependentJob != null) {
                                        ...
                                        if (missingQuantity > 0) {
                                            ...
                                            if (!simulate) {
                                                dependentJob
                                                    .addToIngredientsStorageBuffer(ingredientComponent, toExtract);
                                            }
        ...
        return new IIngredientChannelInsertPreConsumer.Result<>(
            matcher.withQuantity(instance, instanceAmount),
