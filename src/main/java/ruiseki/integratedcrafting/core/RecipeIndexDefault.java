...
public class RecipeIndexDefault implements IRecipeIndexModifiable {
    ...
    public <T, M> Iterator<IRecipeDefinition> getRecipes(IngredientComponent<T, M> outputType, T output,
        ...
        return new DistinctIterator<>(
            MultitransformIterator.flattenIterableIterator(
                Iterators.transform(
                    ((IIngredientMapMutable<T, M, Set<IRecipeDefinition>>) index).iterator(output, matchCondition),
    ...
    public void addRecipe(IRecipeDefinition prioritizedRecipe) {
        ...
        for (IngredientComponent<?, ?> recipeComponent : prioritizedRecipe.getOutput()
            .getComponents()) {
            IIngredientMapMutable<?, ?, Set<IRecipeDefinition>> index = recipeComponentIndexes
    ...
    protected <T, M> void addRecipeForComponent(IIngredientMapMutable<T, M, Set<IRecipeDefinition>> index,
        ...
        for (T instance : prioritizedRecipe.getOutput()
